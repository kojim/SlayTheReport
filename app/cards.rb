...
$cards = {
  ...
  "Brutality"=>             ["Power",  true,  1], # 残虐
  "Brutality+"=>            ["Power",  true,  1], #
  ...
  "CalculatedGamble"=>      ["Skill",  true,  4], # イカサマ (★割り切り)
  "CalculatedGamble+"=>     ["Skill",  false, 4], #
  ...
  "Expertise"=>             ["Skill",  false, 3], # 職人技 (★割り切り)
  ...
  "CompileDriver"=>         ["Attack", false, 2], # コンパイルドライバ (★割り切り)
  ...
  "MachineLearning"=>       ["Power",  true,  1], # 機械学習
  "MachineLearning+"=>      ["Power",  true,  1], #
  ...
  "Strike_P"=>              [], # ストライク
  "Strike_P+"=>             [], #
  "BowlingBash"=>           [], # ボーリングバッシュ
  "BowlingBash+"=>          [], #
  "Consecrate"=>            [], # 聖別
  "Consecrate+"=>           [], #
  "CrushJoints"=>           [], # 関節破壊
  "CrushJoints+"=>          [], #
  "CutThroughFate"=>        [], # 運命の切り開き
  "CutThroughFate+"=>       [], #
  "EmptyFist"=>             [], # 無の型拳
  "EmptyFist+"=>            [], #
  "FlurryOfBlows"=>         [], # 連打
  ...
  "WheelKick"=>             [], # 回し蹴り
  "WheelKick+"=>            [], #
  "WindmillStrike"=>        [], # ウィンドストライク
  "WindmillStrike+"=>       [], #
  "Brilliance"=>            [], # 光輝
  "Brilliance+"=>           [], #
  "LessonLearned"=>         [], # 得られた教訓
  "LessonLearned+"=>        [], #
  "Ragnarok"=>              [], # ラグナロク
  "Ragnarok+"=>             [], #
  ...
  "Evaluate"=>              ["Skill",  false, 1], # 評価 (★割り切り)
  "Evaluate+"=>             ["Skill",  false, 2], #
  ...
  "Scrawl"=>                ["Skill",  false, 6], # 走り書き (★割り切り)
  ...
  "MasterofStrategy"=>      ["Skill",  true,  0], # 戦略家
  "MasterofStrategy+"=>     ["Skill",  true,  0], #
